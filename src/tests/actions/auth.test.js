...
describe('Pruebas en las acciones del auth', () => {
    ...
    test('startLogin correcto ', async() => {
        ...
        await store.dispatch(startLogin('alberto@gmail.com','123456') );
    ...
    test('startLogin incorrecto ', async() => {
        await store.dispatch(startLogin('alberto@gmail.com','12233456') );
        let actions = store.getActions();
        
        expect(actions).toEqual([]);
        expect(Swal.fire).toHaveBeenCalledWith('Error', 'Password incorrecto', 'error');

        await store.dispatch(startLogin('alberto@gm2ail.com','123456') );
